...
class LineTest {
    ...
    void makeLineStatus() {
        ...
        assertThat(line.getStatuses()).containsExactly(CONNECTED, UNCONNECTED, CONNECTED);
    }
    ...
    void nonOverlappingLine() {
        ...
        assertThat(line.getStatuses()).containsExactly(CONNECTED, UNCONNECTED, CONNECTED, UNCONNECTED);
    }
}
